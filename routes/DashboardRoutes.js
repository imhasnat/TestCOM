...
export const DashboardMenu = [
  ...
  },
  {
    ...
    icon: "layers",
    children: [
      { id: uuid(), link: "/store/store-form", name: "Store " },
      { id: uuid(), link: "/product/product-form", name: "Product " },
      { id: uuid(), link: "/product/brand-form", name: "Brand " },
      { id: uuid(), link: "/product/category-form", name: "Category " },
      { id: uuid(), link: "/store/coupon-form", name: "Coupon " },
      { id: uuid(), link: "/banner/banner-form", name: "Banner " },
    ],
  },
  {
    id: uuid(),
    ...
    icon: "layers",
    children: [
      { id: uuid(), link: "/store/store-list", name: "Store " },
      { id: uuid(), link: "/product/product-list", name: "Product " },
    ],
  },
  // {
  //   id: uuid(),
